...
export const DEFAULT_KIT_NAMES: Record<number, { name: string; drum: DrumType }> = {
  0: { name: 'KICK', drum: 'kick' },
  1: { name: 'SNARE', drum: 'snare' },
  2: { name: 'CLAP', drum: 'clap' },
  3: { name: 'C.HAT', drum: 'closedHat' },
  4: { name: 'O.HAT', drum: 'openHat' },
  5: { name: 'RIM', drum: 'rimshot' },
  6: { name: 'LO TOM', drum: 'lowTom' },
  7: { name: 'MD TOM', drum: 'midTom' },
  8: { name: 'HI TOM', drum: 'highTom' },
  9: { name: 'COWBL', drum: 'cowbell' },
  10: { name: 'CRASH', drum: 'crash' },
  11: { name: 'RIDE', drum: 'ride' },
  12: { name: 'SHAKER', drum: 'shaker' },
  13: { name: 'CONGA', drum: 'conga' },
  14: { name: 'CLAVES', drum: 'claves' },
  15: { name: 'PERC', drum: 'clave2' },
};
